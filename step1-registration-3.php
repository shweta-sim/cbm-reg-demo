  ...
  <div id="content" class="step1-registration bg-gradiant">
              ...
              <div class="row">
                <div class="col-md-3 col-lg-3 col-xl-3 p0">
                  <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
                    <li class="nav-item step1"> <a class="nav-link completed" href="step1-registration-1.php">Profile <br>Information</a> </li>
                    <li class="nav-item step2"> <a class="nav-link completed" href="step1-registration-2.php">Address <br>Information</a> </li>
                    <li class="nav-item step3"> <a class="nav-link active" href="step1-registration-3.php">Payout <br>Information</a> </li>
                  </ul>
                </div>
                <div class="col-md-9 col-lg-9 col-xl-9">
                  <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane show active">
                      <h4 class="text-blue text-uppercase text-semibold mb4">Payout Information</h4>
                      <form action="">
                        <div class="row mb4">
                          <div class="col-lg-6">
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-6">
                            <div class="form-group">
                              <label for="biccode">BIC Code <span>*</span></label>
                              <input type="text" class="form-control" id="biccode" placeholder="">
                            </div>
                          </div>
                        </div>
                        <div class="row mb2">
                          <div class="col-md-12">
                            <div class="custom-control custom-checkbox agree mb2">
                              <input type="checkbox" class="custom-control-input" id="customCheck3" name="example1">
                              <label class="custom-control-label text-normal" for="customCheck3">I accept the <a href="#">privacy policy</a><span>*</span></label>
                              <p class="text-sm text-grey">If you would like to receive notification mails updating you directly on activities in your system, you need to check the following box.</p>
                            </div>
                            <div class="custom-control custom-checkbox agree mb2">
                              <input type="checkbox" class="custom-control-input" id="customCheck4" name="example1">
                              <label class="custom-control-label text-normal" for="customCheck4">I would like to receive notification mails <a href="#"><i class="fa fa-info-circle"></i></a></label>
                              <p class="text-sm text-grey">In order to keep receiving updates on the company or its products, please let us know here if you want to receive mails.</p>
                            </div>
                            <div class="custom-control custom-checkbox agree">
                              <input type="checkbox" class="custom-control-input" id="customCheck5" name="example1">
                              <label class="custom-control-label text-normal" for="customCheck5">I would like to receive marketing mails <a href="#"><i class="fa fa-info-circle"></i></a></label>
                            </div>
                          </div>
                        </div>
                      </form>
                      <div class="text-right">
                        <button type="submit" class="btn btn-primary">Proceed <i class="fa fa-angle-right"></i></button>
                      </div>
                    </div>
                    <!-- Tab 3 Content End --> 
                  </div>
