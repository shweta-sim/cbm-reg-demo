                ...
                <div class="col-md-3 col-lg-3 col-xl-3 p0">
                  <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
                    <li class="nav-item step1"> <a class="nav-link completed" href="step1-registration-1.php">Profile <br>
                      Information</a> </li>
                    <li class="nav-item step2"> <a class="nav-link completed" href="step1-registration-2.php">Address <br>
                      Information</a> </li>
                    <li class="nav-item step3"> <a class="nav-link active" href="step1-registration-3.php">Payout <br>
                      Information</a> </li>
                  </ul>
                </div>
