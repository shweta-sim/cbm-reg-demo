  ...
  <div id="content" class="step1-registration bg-gradiant">
    <div class="content-inner">
      ...
      <div class="container-fluid">
        <div class="row mb3">
          <div class="col-md-12">
            <div class="logo"><a href="index.php"><img src="imgs/logo.svg" class="img-fluid mauto"></a></div>
          </div>
        </div>
        <div class="row">
              ...
              <div class="row">
                <div class="col-md-3 col-lg-3 col-xl-3 p0">
                  <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
                    <li class="nav-item step1"> <a class="nav-link active" href="step1-registration-1.php">Profile <br>
                      Information</a> </li>
                    <li class="nav-item step2"> <a class="nav-link" href="step1-registration-2.php">Address <br>
                      Information</a> </li>
