  ...
  <div id="content" class="step1-registration bg-gradiant">
              ...
              <div class="row">
                <div class="col-md-3 col-lg-3 col-xl-3 p0">
                  <ul class="nav nav-tabs flex-column" id="myTab" role="tablist">
                    <li class="nav-item step1"> <a class="nav-link active" href="step1-registration-1.php">Profile <br>Information</a> </li>
                    <li class="nav-item step2"> <a class="nav-link" href="step1-registration-2.php">Address <br>Information</a> </li>
                    <li class="nav-item step3"> <a class="nav-link" href="step1-registration-3.php">Payout <br>Information</a> </li>
                  </ul>
                </div>
                <div class="col-md-9 col-lg-9 col-xl-9">
                  <div class="tab-content" id="myTabContent"> 
                    ...
                    <div class="tab-pane show active">
                      <h4 class="text-blue text-uppercase text-semibold mb4">Profile Information</h4>
                      <form action="">
                        <div class="row mb4">
                          <div class="col-lg-6">
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="form-group">
                              ...
                              <input type="password" class="form-control mb1" id="repeatpassword" placeholder="">
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                      ...
                      <div class="text-right">
                        <button type="submit" class="btn btn-primary" onclick="location.href = 'step1-registration-2.php';">Proceed <i class="fa fa-angle-right"></i></button>
                      </div>
                    </div>
                    <!-- Tab 1 Content End -->                     
                  </div>
